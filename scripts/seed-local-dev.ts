...
const PRODUCTS: ProductSeed[] = [
  ...
  { externalId: 1006, brand: 'Elf Bar', flavor: 'Strawberry Kiwi', category: 'disposable', strength: '0', tasteProfile: 'фруктовый,ягодный', retailPrice: 18, postStock: 9 },
  { externalId: 1007, brand: 'Lost Mary', flavor: 'Triple Mango', category: 'disposable', strength: '0', tasteProfile: 'тропический', retailPrice: 19, postStock: 7 },
  { externalId: 1008, brand: 'Fumot', flavor: 'Mint Ice', category: 'disposable', strength: '0', tasteProfile: 'освежающий,холодок', retailPrice: 17, postStock: 11 },
  ...
  { externalId: 4001, brand: 'Vaporesso', flavor: 'XROS 3 — чёрный', category: 'vape', strength: '', tasteProfile: '', retailPrice: 85, postStock: 3 },
  { externalId: 4002, brand: 'Vaporesso', flavor: 'XROS 3 — серебро', category: 'vape', strength: '', tasteProfile: '', retailPrice: 85, postStock: 2 },
  { externalId: 4003, brand: 'GeekVape', flavor: 'Aegis Boost 2 — синий', category: 'vape', strength: '', tasteProfile: '', retailPrice: 95, postStock: 2 },
  { externalId: 4004, brand: 'GeekVape', flavor: 'Aegis Boost 2 — чёрный', category: 'vape', strength: '', tasteProfile: '', retailPrice: 95, postStock: 3 },
  { externalId: 4005, brand: 'Uwell', flavor: 'Caliburn G3 — серый', category: 'vape', strength: '', tasteProfile: '', retailPrice: 78, postStock: 4 },
  { externalId: 4006, brand: 'SMOK', flavor: 'Nord 5 — красный', category: 'vape', strength: '', tasteProfile: '', retailPrice: 72, postStock: 2 },
  ...
  { externalId: 5005, brand: 'Uwell', flavor: 'Caliburn G3 pod 0.9', category: 'consumable', strength: '', tasteProfile: '', retailPrice: 9, postStock: 14 },
  { externalId: 5006, brand: 'SMOK', flavor: 'Nord 5 pod 0.6', category: 'consumable', strength: '', tasteProfile: '', retailPrice: 8, postStock: 18 },
]
...
async function main() {
  ...
  const [locations, zones, visibleProducts, addresses] = await Promise.all([
    locationRepo.count(),
    zoneRepo.count(),
  ...
  console.log(
    `Local dev seed OK: locations=${locations}, zones=${zones}, catalogProducts=${visibleProducts}, promotedAddresses=${addresses}, seeded=[${byCategory}]`,
  )
  await ds.destroy()
}
